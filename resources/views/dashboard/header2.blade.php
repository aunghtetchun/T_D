<div class="p-2 d-flex px-0 bg-dark shadow-sm rounded justify-content-between align-items-center header animate__animated animate__fadeIn">
        <button class="btn btn-secondary d-inline d-lg-none aside-menu-open mb-0">
        ...
        <div class="text-center">
            <h4 class=" text-light pr-5">
                    {{ App\User::where('role','admin')->first()->name }}
                </h4>
        </div>
        <!-- <div class="dropdown">
